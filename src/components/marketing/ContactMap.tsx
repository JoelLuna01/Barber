    ...
    <section id="ubicacion" className="w-full bg-[#111111] py-28 lg:py-36">
      <div className="mx-auto max-w-7xl px-6 md:px-12">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            <h2 className="font-serif text-4xl font-bold text-[#F3EDE2] sm:text-5xl max-w-md">
              Visítanos en el<br />corazón de la ciudad.
            </h2>
            <Link
              href="/b/barberbook-studio/book"
              className="shrink-0 inline-flex items-center gap-2 rounded-full bg-[#D89B2B] px-7 py-3.5 text-xs font-bold uppercase tracking-wider text-[#0B0B0C] transition-all hover:bg-[#e0a835] active:scale-[0.97]"
            >
              Agendar Ritual
        ...
        <div className="grid gap-6 lg:grid-cols-12 lg:items-stretch">
          ...
          >
            {/* Contact items */}
            <div className="rounded-2xl border border-white/5 bg-[#15171A] p-6 space-y-5">
              {contactItems.map(item => (
                <a
                  ...
                  className="group flex items-start gap-4 p-2 rounded-xl transition duration-200 hover:bg-[#1B1D21]"
                >
                  ...
                  <div>
                    <p className="text-[9px] font-bold uppercase tracking-widest text-[#A1A1AA]">{item.label}</p>
                    <p className="mt-0.5 text-[13.5px] font-semibold text-[#F3EDE2] group-hover:text-[#D89B2B] transition-colors">
                      {item.value}
                    </p>
                  </div>
                </a>
            ...
            {/* Hours */}
            <div className="rounded-2xl border border-white/5 bg-[#15171A] p-6">
              <div className="mb-5 flex items-center gap-2">
                <Clock className="h-4 w-4 text-[#D89B2B]" />
                <span className="text-[11px] font-bold uppercase tracking-widest text-[#F3EDE2]">Horarios de Atención</span>
              </div>
                  ...
                  return (
                    ...
                    >
                      <span className={`font-semibold ${isToday ? "text-[#D89B2B]" : "text-[#A1A1AA]"}`}>
                        {h.day}
                        {isToday && <span className="ml-2 text-[8px] font-bold uppercase tracking-wider bg-[#D89B2B]/20 px-1.5 py-0.5 rounded text-[#D89B2B]">Hoy</span>}
                      </span>
          ...
          <motion.div
            ...
            className="relative overflow-hidden rounded-2xl border border-white/5 bg-[#15171A] lg:col-span-7 min-h-[380px]"
          >
            <iframe
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="absolute bottom-5 right-5 flex items-center gap-2 rounded-full border border-white/10 bg-[#0B0B0C]/80 px-4.5 py-2.5 text-xs font-bold uppercase tracking-wider text-[#F3EDE2] backdrop-blur-sm transition hover:border-[#D89B2B]/40 hover:text-[#D89B2B]"
            >
